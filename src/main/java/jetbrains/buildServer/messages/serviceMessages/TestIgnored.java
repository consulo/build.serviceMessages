...
public class TestIgnored extends BaseTestMessage {
  ...
  public TestIgnored(@NotNull final String name, @NotNull String ignoreComment) {
    super(ServiceMessageTypes.TEST_IGNORED, name, Collections.singletonMap("message", ignoreComment));
  }
