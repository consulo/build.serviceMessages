...
public class TestStdOut extends BaseTestMessage {
  ...
  public TestStdOut(@NotNull final String name, @NotNull final String testOutput) {
    super(ServiceMessageTypes.TEST_STD_OUT, name, Collections.singletonMap("out", testOutput));
  }
